...
public class Constants {
    ...
    public static final int SIMULATION_INPUT_PARAMETERS_COUNT = 7;
    public static final int AGENT_INPUT_PARAMETERS_COUNT = 4;
    public static final int INFECTION_PROBABILITY_MODIFIER = 11;
    public static final int ILLNESS_DURATION_MODIFIER = 6;
}